...
```
  ...
  - ranon*tsika* => our water incl.
  - ranon*ay* => our water excl.
  - ranon*areo* => your water
  - rano*n'isy reo* => their water
```

- There is a distinction between an all-encompassing **we** & the **we** in opposition to another group.
